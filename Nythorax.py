...
from cpmnuker import  Nythorax 666
 
__CHANNEL_USERNAME__ = "Whatsapp 923302324348"
__GROUP_USERNAME__   = "Whatsapp 923302324348"
...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, f' ‌           To Buy: @{__CHANNEL_USERNAME__} 𝐎𝐫 @{__GROUP_USERNAME__}'))
    print(Colorate.Horizontal(Colors.rainbow, '=================================================================='))
